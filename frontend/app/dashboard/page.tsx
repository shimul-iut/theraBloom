    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Overview of your therapy center
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Welcome to Therapy Center Platform</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground">
            You are logged in as <span className="font-medium">{user?.firstName} {user?.lastName}</span> ({user?.role})
          </p>
